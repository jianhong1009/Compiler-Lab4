...
public interface lab4Visitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link lab4Parser#return_}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitReturn_(lab4Parser.Return_Context ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link lab4Parser#eqNeq}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitEqNeq(lab4Parser.EqNeqContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link lab4Parser#compare}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitCompare(lab4Parser.CompareContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link lab4Parser#addSub}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitAddSub(lab4Parser.AddSubContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link lab4Parser#mulDiv}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitMulDiv(lab4Parser.MulDivContext ctx);
	/**
